...
public class NumberCellValue extends SimpleCellValue<BigDecimal> {
    public NumberCellValue(Cell cell, Double value) {
        super(cell, BigDecimal.valueOf(value));
    }
    public NumberCellValue(Cell cell, BigDecimal value) {
        super(cell, value);
    }
